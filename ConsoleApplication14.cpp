...
void help()
{
	...
	cout << " |---------------------------------------------|  " << endl;
	cout << " | o Additional Options:                       | " << endl;
	cout << " |     -most used cards: frequency             | " << endl;
	cout << " |     -shortcut for exit: Alt + F4            | " << endl;
	cout << " |---------------------------------------------|  " << endl;
...
void menu()
{
	...
	do {
		...
		else if (strcmp(option, "frequency") == 0) showFrequency();
		else {
	...
	do {
		...
		if (money > 0 && compmoney>0)
		{
			...
			while (std::cin.fail())
			{
				std::cin.clear();
				std::cin.ignore(std::numeric_limits<std::streamsize>::max(), '\n');
				std::cout << "Bad entry.  Enter N or Y ";
				std::cin >> bid;
			}
...
void about()
{
	...
	cout << " |         regarding the product  \\:D/         | " << endl;
	cout << " |---------------------------------------------|  " << endl;
	cout << " |    (start | help | score | about | exit)    | " << endl;
